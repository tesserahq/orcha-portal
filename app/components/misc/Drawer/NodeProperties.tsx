...
const NodePropertyDrawer: React.ForwardRefRenderFunction<FuncProps, IProps> = (
  ...
  return (
    <div
      className={cn(
        'fixed right-0 top-0 h-full w-full !max-w-screen-sm overflow-auto bg-card pt-32 shadow transition-transform duration-300 ease-in-out',
          ...
          <DialogDescription className="px-3" asChild>
            <div className="flex flex-col items-center">
              ...
              <p className="mb-3 mt-3 text-center text-base text-secondary-foreground">
                Are you sure you want to delete &quot;{nodeData?.title}&quot;? This action
                cannot be undone.
              </p>
            </div>
          </DialogDescription>
