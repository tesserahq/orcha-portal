...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input
      ...
      className={cn(
        'flex-1 rounded-none border-none bg-transparent shadow-none outline-none focus-visible:ring-transparent focus-visible:ring-offset-0 dark:bg-transparent',
        className,
      )}
      {...props}
    />
